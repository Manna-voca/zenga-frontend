...
const Album = () => {
  ...
  const handleDownloadImgClick = async () => {
    ...
    image.src =
      albumList[initialNum].imageUrl + "?timestamp=" + new Date().getTime();
      ...
      {memberState ? (
        ...
        <>
          ...
          <Swiper
            ...
            observeParents={true}
            onSlideChange={(e) => {
              setInitialNum(e.activeIndex);
              window.history.replaceState(
                {},
                "",
                `${window.location.origin}${window.location.pathname}?who=${who}&index=${e.activeIndex}`
              );
            }}
          >
